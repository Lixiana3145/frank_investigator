  ...
  def investigation_json
    {
      ...
      contextual_gaps: @investigation.contextual_gaps,
      coordinated_narrative: @investigation.coordinated_narrative,
      emotional_manipulation: @investigation.emotional_manipulation,
      source_misrepresentation: @investigation.source_misrepresentation,
      temporal_manipulation: @investigation.temporal_manipulation,
      statistical_deception: @investigation.statistical_deception,
      selective_quotation: @investigation.selective_quotation,
